...
class appProdProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'D:/PHP_ROOT/ITPProject/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_b32566dcd3966817615e9471b5db66a6');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_b32566dcd3966817615e9471b5db66a6');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_b32566dcd3966817615e9471b5db66a6');
        ...
        $d->setProxyDir('D:/PHP_ROOT/ITPProject/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/PHP_ROOT/ITPProject/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/PHP_ROOT/ITPProject/app/../web', false);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'router.resource' => 'D:/PHP_ROOT/ITPProject/app/config/routing.yml',
